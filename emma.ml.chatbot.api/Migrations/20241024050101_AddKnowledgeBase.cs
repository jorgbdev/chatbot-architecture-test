        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentRepresentativeId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Conversations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Conversations_Participants_CurrentRepresentativeId",
                        column: x => x.CurrentRepresentativeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Conversations_CurrentRepresentativeId",
                table: "Conversations",
                column: "CurrentRepresentativeId");

            migrationBuilder.CreateIndex(
                name: "IX_Entries_TopicId_Key",
                table: "Entries",
